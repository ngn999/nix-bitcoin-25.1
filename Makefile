...
PRE_UNINSTALL = :
POST_UNINSTALL = :
build_triplet = aarch64-apple-darwin23.3.0
host_triplet = aarch64-apple-darwin23.3.0
...
CONFIG_CLEAN_VPATH_FILES = contrib/devtools/iwyu/bitcoin.core.imp \
	contrib/filter-lcov.py contrib/macdeploy/background.tiff \
	test/functional/test_runner.py test/fuzz/test_runner.py \
	test/util/test_runner.py test/util/rpcauth-test.py \
	src/qt/Makefile src/qt/test/Makefile src/test/Makefile
...
ACLOCAL = ${SHELL} '/Users/guinengni/code/cc/bitcoin-25.1/build-aux/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
ANDROID_ARCH = 
AR = /nix/store/65lhhpbfnsf9b3knd4q2l49y7107fisp-clang-wrapper-16.0.6/bin/ar
ARFLAGS = cr
ARM_CRC_CXXFLAGS = 
ARM_SHANI_CXXFLAGS = 
AS = as
AUTOCONF = ${SHELL} '/Users/guinengni/code/cc/bitcoin-25.1/build-aux/missing' autoconf
AUTOHEADER = ${SHELL} '/Users/guinengni/code/cc/bitcoin-25.1/build-aux/missing' autoheader
AUTOMAKE = ${SHELL} '/Users/guinengni/code/cc/bitcoin-25.1/build-aux/missing' automake-1.16
AVX2_CXXFLAGS = 
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
...
ECHO_N = -n
ECHO_T = 
EGREP = /nix/store/08nb1wjqrmcr8x0g7l1p3i8j16in3606-gnugrep-3.11/bin/grep -E
ENABLE_EXTERNAL_SIGNER = 
ERROR_CXXFLAGS = 
ETAGS = etags
EVENT_CFLAGS = -I/nix/store/f43h9hn15g58bk91gsi41q35k1kd7j37-libevent-2.1.12-dev/include
EVENT_LIBS = -L/nix/store/bcq86l52xw8xa1q8jmzm45fh7k5gr796-libevent-2.1.12/lib -levent
EVENT_PTHREADS_CFLAGS = -D_THREAD_SAFE -I/nix/store/f43h9hn15g58bk91gsi41q35k1kd7j37-libevent-2.1.12-dev/include
EVENT_PTHREADS_LIBS = -L/nix/store/bcq86l52xw8xa1q8jmzm45fh7k5gr796-libevent-2.1.12/lib -levent_pthreads -levent
EXEEXT = 
EXTENDED_FUNCTIONAL_TESTS = 
FGREP = /nix/store/08nb1wjqrmcr8x0g7l1p3i8j16in3606-gnugrep-3.11/bin/grep -F
FILECMD = file
GCOV = /usr/bin/gcov
GENHTML = 
GIT = /nix/store/ylm8lw53fkk4hmxaccirg67fcrwp4q6w-git-2.43.0/bin/git
GPROF_CXXFLAGS = 
GPROF_LDFLAGS = 
GREP = /nix/store/08nb1wjqrmcr8x0g7l1p3i8j16in3606-gnugrep-3.11/bin/grep
...
INSTALL = /nix/store/05f94jq5l6kfs9s3gyzj28y1v4xf6hfm-coreutils-9.4/bin/install -c
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} '/Users/guinengni/code/cc/bitcoin-25.1/build-aux/missing' makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
MKDIR_P = /nix/store/05f94jq5l6kfs9s3gyzj28y1v4xf6hfm-coreutils-9.4/bin/mkdir -p
MOC = 
...
PACKAGE_STRING = Bitcoin Core 25.1.0
...
PIC_FLAGS = -fPIC
PIE_FLAGS = 
PKG_CONFIG = /nix/store/xrxy4642194vdyq0a9cdb9d29y97drab-pkg-config-wrapper-0.29.2/bin/pkg-config
PKG_CONFIG_LIBDIR = 
PKG_CONFIG_PATH = 
PTHREAD_CC = clang
PTHREAD_CFLAGS = -pthread
PTHREAD_CXX = clang++ -std=c++17
PTHREAD_LIBS = -lpthread
PYTHON = /run/current-system/sw/bin/python3.11
PYTHONPATH = 
QR_CFLAGS = 
QR_LIBS = 
...
SANITIZER_CXXFLAGS = 
SANITIZER_LDFLAGS = 
SED = /nix/store/v5mi2yzla9d240q8jfmrav754lqr3qha-gnused-4.9/bin/sed
SET_MAKE = 
SHELL = /nix/store/0wzb184kckhmggq1nlvy5xk6rykp0jl1-bash-5.2-p21/bin/bash
SQLITE_CFLAGS = -I/nix/store/2lyc1i36k8m44svph9kjm8m6cf8ymzax-sqlite-3.44.2-dev/include
SQLITE_LIBS = -L/nix/store/p0pprkb26is5wisfaaz2cmgzg91phzhk-sqlite-3.44.2/lib -lsqlite3
SSE41_CXXFLAGS = 
SSE42_CXXFLAGS = 
STRIP = strip
TESTDEFS = 
...
USE_UPNP = 
VERSION = 25.1.0
WARN_CXXFLAGS =  -Wall -Wextra -Wgnu -Wformat -Wformat-security -Wvla -Wshadow-field -Wthread-safety -Wloop-analysis -Wredundant-decls -Wunused-member-function -Wdate-time -Wconditional-uninitialized -Woverloaded-virtual -Wsuggest-override -Wunreachable-code-loop-increment -Wimplicit-fallthrough
WINDRES = 
X86_SHANI_CXXFLAGS = 
XGETTEXT = 
XORRISOFS = 
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /Users/guinengni/code/cc/bitcoin-25.1
abs_srcdir = /Users/guinengni/code/cc/bitcoin-25.1
abs_top_builddir = /Users/guinengni/code/cc/bitcoin-25.1
abs_top_srcdir = /Users/guinengni/code/cc/bitcoin-25.1
ac_ct_AR = 
ac_ct_CC = clang
ac_ct_CXX = 
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/guinengni/code/cc/bitcoin-25.1/build-aux/install-sh
