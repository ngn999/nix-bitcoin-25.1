...
PRE_UNINSTALL = :
POST_UNINSTALL = :
build_triplet = aarch64-apple-darwin23.1.0
host_triplet = aarch64-apple-darwin23.1.0
...
ANDROID_ARCH = 
AR = /nix/store/sa6hywsm1mqfyd1xakyzv4ljjsb3hawh-clang-wrapper-11.1.0/bin/ar
ARFLAGS = cr
ARM_CRC_CXXFLAGS = 
ARM_SHANI_CXXFLAGS = 
AS = as
...
CXXFLAGS = 
CYGPATH_W = echo
DEBUG_CPPFLAGS =  -DDEBUG -DDEBUG_LOCKORDER -DDEBUG_LOCKCONTENTION -DRPC_DOC_CHECK -DABORT_ON_FAILED_ASSUME
...
ECHO_N = -n
ECHO_T = 
EGREP = /nix/store/kxbn7dv0i7p0ylsbr53j7z0gf45kim78-gnugrep-3.11/bin/grep -E
ENABLE_EXTERNAL_SIGNER = 
ERROR_CXXFLAGS = 
ETAGS = etags
EVENT_CFLAGS = -I/nix/store/hqbdgflvpvny077i0z9k38dras45rld9-libevent-2.1.12-dev/include
EVENT_LIBS = -L/nix/store/wkwl6wciv7ijm51v7li26sf9vydbj4w3-libevent-2.1.12/lib -levent
EVENT_PTHREADS_CFLAGS = -D_THREAD_SAFE -I/nix/store/hqbdgflvpvny077i0z9k38dras45rld9-libevent-2.1.12-dev/include
EVENT_PTHREADS_LIBS = -L/nix/store/wkwl6wciv7ijm51v7li26sf9vydbj4w3-libevent-2.1.12/lib -levent_pthreads -levent
EXEEXT = 
EXTENDED_FUNCTIONAL_TESTS = 
FGREP = /nix/store/kxbn7dv0i7p0ylsbr53j7z0gf45kim78-gnugrep-3.11/bin/grep -F
FILECMD = file
GCOV = /usr/bin/gcov
GENHTML = 
GIT = /nix/store/0ifwlmw97aq4ic4l69j3kh677lay4kmx-git-2.42.0/bin/git
GPROF_CXXFLAGS = 
GPROF_LDFLAGS = 
GREP = /nix/store/kxbn7dv0i7p0ylsbr53j7z0gf45kim78-gnugrep-3.11/bin/grep
HARDENED_CPPFLAGS = 
...
INSTALL = /nix/store/943sxl4vcfpfg6xaagxvgwbgz9scl7lc-coreutils-9.3/bin/install -c
...
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
MKDIR_P = /nix/store/943sxl4vcfpfg6xaagxvgwbgz9scl7lc-coreutils-9.3/bin/mkdir -p
MOC = 
...
PIC_FLAGS = -fPIC
PIE_FLAGS = 
PKG_CONFIG = /nix/store/qn4rg6zdcfc6jb8d0yiwa30w7k2dscvv-pkg-config-wrapper-0.29.2/bin/pkg-config
PKG_CONFIG_LIBDIR = 
PKG_CONFIG_PATH = 
PTHREAD_CC = clang
...
PYTHON = /Users/guinengni/.nix-profile/bin/python3.11
PYTHONPATH = 
QR_CFLAGS = 
QR_LIBS = 
...
SANITIZER_CXXFLAGS = 
SANITIZER_LDFLAGS = 
SED = /nix/store/fh1327f06qipzcnv2di22vssbbzk1hrz-gnused-4.9/bin/sed
SET_MAKE = 
SHELL = /nix/store/zzpm4317hn2y29rm46krsasaww9wxb1k-bash-5.2-p15/bin/bash
SQLITE_CFLAGS = 
SQLITE_LIBS = 
SSE41_CXXFLAGS = 
SSE42_CXXFLAGS = 
